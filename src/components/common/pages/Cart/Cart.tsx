        ...
        <div className="container mx-auto px-4">
          {cartItems.length > 0 ? (
            <div className="flex flex-col lg:flex-row gap-10">
              <div className="felx-1 flex flex-col gap-6">
                {cartItems.map((item) => (
                  <div
                    key={item.id}
                  ...
                  >
                    <div className="flex items-center gap-6">
                      ...
                      <div className="">
                        ...
                        <p className="text-[#525C60] font-bold">${item.price}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <button className="text-[#274C5B] hover:text-red-500 transition-colors">
                        ✕
                      </button>
                    </div>
                  </div>
